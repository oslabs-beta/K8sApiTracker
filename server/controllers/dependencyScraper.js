...
var dependencyScraperController = {
    ...
    getDependencies: function (req, res, next) {
        ...
        var getYaml = function () { return __awaiter(void 0, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, glob('**/*.yaml', { ignore: 'node_modules/**' })];
                    case 1:
                        response = _a.sent();
        ...
        getYaml()
            ...
            try {
                ...
                for (var _i = 0, data_1 = data; _i < data_1.length; _i++) {
                    ...
                    var properties = ['apiVersion', 'kind', 'name', 'namespace', 'image'];
                    var defaults = ['NA', 'NA', 'NA', 'Default', 'NA'];
                    for (var i = 0; i < properties.length; i++) {
                        try {
                            var version = new RegExp("".concat(properties[i], ":.*"));
                            var array = version.exec(content);
