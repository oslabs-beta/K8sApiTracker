...
function RowHeader(props) {
    return (react_1.default.createElement("div", { className: 'rowHeader' },
        ...
        react_1.default.createElement("div", { className: 'headerName-status' },
            react_1.default.createElement("div", null, props.status),
            react_1.default.createElement("button", { className: "filter-button" })),
        react_1.default.createElement("div", { className: 'headerName-stable' }, props.stable),
